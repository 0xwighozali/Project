<div class="form-container">
    ...
    <form action="<?=BASEURL;?>/peminjaman/editProcess/<?=$data['pmjmn']['id_peminjaman']?>" method="post">
        <div class="form-group">
            <label for="id_peminjaman" class="form-label">ID Peminjaman</label>
            <input type="text" id="id_peminjaman" name="id_peminjaman" class="form-input" value="<?= $data['pmjmn']['id_peminjaman'];?>" readonly required>
        </div>
