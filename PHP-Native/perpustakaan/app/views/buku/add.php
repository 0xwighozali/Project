<div class="form-container">
    ...
    <form action="<?=BASEURL;?>/buku/addProcess" method="post">
      <div class="form-group">
        <label for="id_buku" class="form-label">ID Buku</label>
        <input type="text" id="id_buku" name="id_buku" class="form-input" value="<?=$data['bk'];?>" readonly>
      </div>

      <div class="form-group">
        <label for="kode_buku" class="form-label">Kode Buku</label>
        <input type="text" id="kode_buku" name="kode_buku" class="form-input" required>
      </div>

      <div class="form-group">
        <label for="judul_buku" class="form-label">Judul Buku</label>
        <input type="text" id="judul_buku" name="judul_buku" class="form-input" required>
      </div>

      <div class="form-group">
        <label for="penerbit_buku" class="form-label">Penerbit Buku</label>
        <input type="text" id="penerbit_buku" name="penerbit_buku" class="form-input" required>
      </div>
      
      <div class="form-group">
        <label for="tahun_penerbit" class="form-label">Tahun Terbit</label>
        <input type="text" id="tahun_penerbit" name="tahun_penerbit" class="form-input" required>
      </div>
