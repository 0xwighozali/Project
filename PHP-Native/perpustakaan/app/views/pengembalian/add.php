<div class="form-container">
    ...
    <form action="<?=BASEURL;?>/pengembalian/addProcess" method="post">
        <div class="form-group">
            <label for="id_peminjaman" class="form-label">ID Pengembalian</label>
            <input type="text" id="id_pengembalian" name="id_pengembalian" class="form-input" value="<?= $data['pngmbln'];?>" readonly required>
        </div>
...
$(document).ready(function () {
  $('#multi_option').change(function () {
    ...
    // Kirim permintaan AJAX ke server untuk mengambil data berdasarkan ID peminjaman
    $.ajax({
      ...
      success: function (data) {
        // Update nilai-nilai input ID buku, ID member, dan ID petugas
